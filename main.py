...
app = FastAPI(title='Backstract Generated APIs - coll-06da477a418744fd833329bc22d6354f', debug=False,
              docs_url='/ecstatic-surya-b8bde854581611f0bdad8e05aa13f23472/docs',
              openapi_url='/ecstatic-surya-b8bde854581611f0bdad8e05aa13f23472/openapi.json')
...
app.include_router(
    router,
    prefix='/ecstatic-surya-b8bde854581611f0bdad8e05aa13f23472/api',
    tags=['APIs v1']
)
